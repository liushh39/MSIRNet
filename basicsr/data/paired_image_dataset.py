...
class PairedImageDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.gt_folder, self.lq_folder, self.mask_grid1_folder, self.mask_grid2_folder, self.mask_grid3_folder = opt[
                                                                                                                     'dataroot_gt'], \
                                                                                                                 opt[
                                                                                                                     'dataroot_lq'], \
                                                                                                                 opt[
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            if self.opt['use_resize_crop']:
                ...
                # random crop
                img_gt, img_lq, img_mask_grid11, img_mask_grid22, img_mask_grid33 = paired_random_crop_prior(img_gt,
                                                                                                             img_lq,
                                                                                                             img_mask_grid11,
                                                                                                             img_mask_grid22,
                                                                                                             img_mask_grid33,
                                                                                                             gt_size,
                                                                                                             input_gt_size // input_lq_size,
                                                                                                             gt_path)

            # flip, rotation
            img_gt, img_lq, img_mask_grid11, img_mask_grid22, img_mask_grid33 = augment_prior(
                [img_gt, img_lq, img_mask_grid11, img_mask_grid22, img_mask_grid33], self.opt['use_flip'],
                self.opt['use_rot'])
        ...
        return {'lq': img_lq, 'gt': img_gt, 'lq_path': lq_path, 'gt_path': gt_path, 'mask_grid1': img_mask_grid111,
                'mask_grid2': img_mask_grid222, 'mask_grid3': img_mask_grid333}
        # return {
        #     'lq': img_lq,
        #     'gt': img_gt,
        #     'lq_path': lq_path,
