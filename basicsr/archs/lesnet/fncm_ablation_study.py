...
class FRNet_no_MLP(nn.Module):
    ...
    def __init__(self, channels, height=None, width=None, weight_type="bit", num_layers=1, att_size=8, mlp_layer=256):
        ...
        type: bit or vector
        """
        super(FRNet_no_MLP, self).__init__()
        # IEU_G computes complementary features.
        self.IEU_G = IEU_no_MLP(channels, height, width, weight_type="bit",
                         bit_layers=num_layers, att_size=att_size, mlp_layer=mlp_layer)

        # IEU_W computes bit-level or vector-level weights.
        self.IEU_W = IEU_no_MLP(channels, height, width, weight_type=weight_type,
                         bit_layers=num_layers, att_size=att_size, mlp_layer=mlp_layer)
...
class FRNet_no_SA(nn.Module):
    ...
    def __init__(self, channels, height=None, width=None, weight_type="bit", num_layers=1, att_size=8, mlp_layer=256):
        ...
        type: bit or vector
        """
        super(FRNet_no_SA, self).__init__()
        # IEU_G computes complementary features.
        self.IEU_G = IEU_no_SA(channels, height, width, weight_type="bit",
                         bit_layers=num_layers, att_size=att_size, mlp_layer=mlp_layer)

        # IEU_W computes bit-level or vector-level weights.
        self.IEU_W = IEU_no_SA(channels, height, width, weight_type=weight_type,
                         bit_layers=num_layers, att_size=att_size, mlp_layer=mlp_layer)
...
class FRNet_CSGate1(nn.Module):
    ...
    def __init__(self, channels, height=None, width=None, weight_type="bit", num_layers=1, att_size=8, mlp_layer=256):
        ...
        type: bit or vector
        """
        super(FRNet_CSGate1, self).__init__()
        # IEU_G computes complementary features.
        self.IEU_G = IEU(channels, height, width, weight_type="bit",
                         bit_layers=num_layers, att_size=att_size, mlp_layer=mlp_layer)
    ...
    def forward(self, x_img):
        ...
        wegiht_matrix = torch.sigmoid(self.IEU_W(x_img))
        # CSGate
        x_out = x_img * wegiht_matrix + x_img
        return x_out


#######______ E+Eg，w/o IU unit
class FRNet_CSGate2(nn.Module):
    """
    Feature refinement network：
    (1) IEU
    (2) CSGate
    ...
    def __init__(self, channels, height=None, width=None, weight_type="bit", num_layers=1, att_size=8, mlp_layer=256):
        ...
        type: bit or vector
        """
        super(FRNet_CSGate2, self).__init__()
        # IEU_G computes complementary features.
        self.IEU_G = IEU(channels, height, width, weight_type="bit",
                         bit_layers=num_layers, att_size=att_size, mlp_layer=mlp_layer)
...
class IEU_no_MLP(nn.Module):
    ...
    def __init__(self, channels, height=None, width=None, weight_type="bit",
        ...
        :param mlp_layer: size of MLP layer for contextual information extraction
        """
        super(IEU_no_MLP, self).__init__()
        # self.input_dim = channels * height * width
        self.weight_type = weight_type
...
class IEU_no_SA(nn.Module):
    ...
    def forward(self, x_img):
        ...
        x_bit = self.Mlp(x_img)
        x_bit = self.bit_projection_mlp(x_bit)
        x_out = x_bit.permute(0, 2, 1).view(B, 1, H, W)
