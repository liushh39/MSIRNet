...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_path', type=str, default='/media/HDD1/yj/yj_LLIE/SeD_nopre/results/')
    parser.add_argument('--gt_path', type=str, default='/media/HDD1/yj/yj_LLIE/dataset/LOL_SR/test/high/')
    # parser.add_argument('--gt_path', type=str, default='/media/HDD1/yj/yj_LLIE/dataset/RELLISUR/Test/NLHR-Duplicates/X4/')
        ...
        try:
          ...
          with torch.no_grad():
            ...
            if iqa_psnr is not None:
              score_psnr_all.append(iqa_psnr(img_out, img_gt, test_y_channel=True).item())   #super_resolution test_y_channel=True
            if iqa_ssim is not None:
              score_ssim_all.append(iqa_ssim(img_out, img_gt, test_y_channel=True).item())   #super_resolution test_y_channel=True
